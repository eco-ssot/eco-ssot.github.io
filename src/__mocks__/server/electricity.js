...
const electricity = [
  ...
  rest.patch(`${process.env.REACT_APP_API_BASE_URL}/electric/anaysis/explanation/:id`, (req, res, ctx) => {
    return res(ctx.json({ id: 1 }));
  }),
  rest.post(`${process.env.REACT_APP_API_BASE_URL}/electric/anaysis/explanation`, (req, res, ctx) => {
    return res(ctx.json({ id: 1 }));
  }),
];
