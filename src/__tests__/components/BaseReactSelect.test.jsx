...
import BaseReactSelect, { BaseAsyncReactSelect } from '../../components/select/BaseReactSelect';

test('BaseReactSelect', () => {
  const { asFragment } = render(<BaseReactSelect />);
...
test('BaseAsyncReactSelect', () => {
  const { asFragment } = render(<BaseAsyncReactSelect />);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <div
        class=" css-ktvv8x-container"
