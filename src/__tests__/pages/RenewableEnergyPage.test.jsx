...
describe('RenewableEnergyHistoryTable', () => {
  ...
  it('single', async () => {
    const { asFragment, queryByText } = renderWithProviders(
      <RenewableEnergyHistoryTable startYear="2016" endYear="2021" monthType="single" endMonth="12" />
    );
  ...
  it('same year', async () => {
    const { asFragment, queryByText } = renderWithProviders(
      <RenewableEnergyHistoryTable startYear="2021" endYear="2021" monthType="YTM" startMonth="1" endMonth="12" />
    );
