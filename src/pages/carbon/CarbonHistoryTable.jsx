...
const HISTORY_COLUMNS = ({ startYear, endYear, startMonth, endMonth, monthType }) => {
  let columns = [];
  if (!isNil(monthType)) {
...
export function toMonthType({ name, metaData = [], plants = [] }) {
  return {
    site: name,
    ...metaData.reduce(
    ...
    subRows: plants.map(toMonthType),
    ...
    <>
      ...
      {data && (
        <div className="w-full flex flex-col shadow overflow-auto rounded-t-lg">
          <Table
            columns={HISTORY_COLUMNS(option)}
