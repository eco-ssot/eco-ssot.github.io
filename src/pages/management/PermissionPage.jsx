    ...
    <div className="row-span-2 col-span-7">
      <div className="flex flex-col bg-primary-900 rounded shadow p-4 h-full">
        ...
        <div className="flex space-x-8 mb-2">
          <div className="w-1/3 text-xl font-medium">P8廠數據可查看權限名單</div>
          <div className="w-1/3 text-xl font-medium">後台參數可設定權限名單</div>
          <div className="w-1/3 text-xl font-medium">開發群組名單</div>
        </div>
