  ...
  return (
    <BrowserRouter history={history}>
      ...
      <Switch>
        ...
        {privateRoutes.map(({ path, component: Component, skeleton: Skeleton, exact = true }, i) => (
          <PrivateRoute exact={exact} key={i} path={path} component={Component} skeleton={Skeleton} />
        ))}
